...
/**
 ...
 첫 번째 카드뭉치에 "drink"와 "water"를 차례대로 사용하면원하는 순서의 단어 배열을 만들 수 있습니다.
...
//                System.out.println("card1 : "+cards1[a] + ", "+ goal[i]);
//                System.out.println(cards1[a] == goal[i] );
                a++;
            }else if(cards2.length > b && cards2[b].equals(goal[i]) ){
//                System.out.println("card2 : "+cards2[b] + ", "+ goal[i]);
//                System.out.println(cards2[b] == goal[i] );
                b++;
            }else{
                answer = "No";
