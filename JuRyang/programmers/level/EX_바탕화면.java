...
//                                };  //(3 - 0) + (4 - 1) = 6
    ...
    public static int[] solution(String[] wallpaper) {
        ...
        System.out.println(wallpaper[0]);
        int minRow, minCol;
        int maxRow, maxCol;
        ...
        String [][] file = new String [wallpaper.length][];

        for (int i = 0; i < wallpaper.length; i++) {
          //  String str = wallpaper[i];
            //file[i] = new String[str.length()];
        ...
        System.out.println(minRow +","+ minCol+","+( maxRow + 1) +","+ (maxCol + 1));
